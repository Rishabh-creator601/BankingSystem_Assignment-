## User class that contains user profile information
class User:
...
## Just for good presentations and introductions of our management system 
print("""
*********************
      WECOME TO
*** Debuggers Hut ***
...
## calculating apartment rate  and setting  it 
